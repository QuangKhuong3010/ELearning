                    ...
                    <div class="col-12">
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                <div class="logo">
                                    <a href="index.jsp"><img src="assets/img/logo/logo.svg" alt="Logo"></a>
                                </div>
                                    ...
                                    <ul class="navigation">
                                            ...
                                            <ul class="sub-menu mega-menu">
                                                <li>
                                                    <ul class="list-wrap mega-sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="index-2.jsp">Online Course <span class="tg-badge">Hot</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="index-3.jsp">University <span class="tg-badge-two">New</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="index-4.jsp">Yoga Instructor<span class="tg-badge-two">New</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="index-5.jsp">Kindergarten<span class="tg-badge">Hot</span></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <ul class="list-wrap mega-sub-menu">
                                                        <li>
                                                            <a href="index-6.jsp">Language Academy<span class="tg-badge-two">New</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="index-7.jsp">Business Coach <span class="tg-badge-two">New</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="index-8.jsp">Kitchen Coach <span class="tg-badge">Hot</span></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <div class="mega-menu-img">
                                                        <a href="courses.jsp"><img src="assets/img/others/mega_menu_img.jpg" alt="img"></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children"><a href="#">Courses</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="lesson.jsp">Course Lesson</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children"><a href="#">Pages</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item-has-children">
                                                    <a href="instructors.jsp">Our Instructors</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="instructors.jsp">Our Instructors</a></li>
                                                        <li><a href="instructor-details.jsp">Instructor Details</a></li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item-has-children">
                                                    <a href="events.jsp">Our Events</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="events.jsp">Our Events</a></li>
                                                ...
                                                <li class="menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="blog-2.jsp">Blog Left Sidebar</a></li>
                                                        <li><a href="blog-3.jsp">Blog Full Width</a></li>
                                ...
                                <div class="tgmenu__action">
                                    <ul class="list-wrap">
                                        <li class="wishlist-icon">
                                            <a href="cart.jsp" class="cart-count">
                                ...
                                <div class="mobile-login-btn">
                                    <a href="Login"><img src="assets/img/icons/user.svg" alt="" class="injectable"></a>
                                </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content">
                            ...
                            <div class="banner__btn-wrap" data-aos="fade-right" data-aos-delay="800">
                                <a href="contact.jsp" class="btn arrow-btn">Start Free Trial <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <div class="tg-button-wrap">
                                <a href="about-us.jsp" class="btn arrow-btn">Start Free Trial <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="instructor__item-wrap">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="instructor__item">
                                        <div class="instructor__thumb">
                                            <a href="instructor-datails.jsp"><img src="assets/img/instructor/instructor02.png" alt="img"></a>
                                        </div>
                                        <div class="instructor__content">
                                            <h2 class="title"><a href="instructor-datails.jsp">Olivia Mia</a></h2>
                                ...
                                <div class="col-sm-6">
                                    <div class="instructor__item">
                                        <div class="instructor__thumb">
                                            <a href="instructor-datails.jsp"><img src="assets/img/instructor/instructor03.png" alt="img"></a>
                                        </div>
                                        <div class="instructor__content">
                                            <h2 class="title"><a href="instructor-datails.jsp">William Hope</a></h2>
                                ...
                                <div class="col-sm-6">
                                    <div class="instructor__item">
                                        <div class="instructor__thumb">
                                            <a href="instructor-datails.jsp"><img src="assets/img/instructor/instructor04.png" alt="img"></a>
                                        </div>
                                        <div class="instructor__content">
                                            <h2 class="title"><a href="instructor-datails.jsp">Sophia Ava</a></h2>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="instructor__item-two tg-svg">
                                ...
                                <div class="instructor__content-two">
                                    <h3 class="title"><a href="contact.jsp">Become a Instructor</a></h3>
                                    <p>To take a trivial example, which of us undertakes physical exercise yes is this happen here.</p>
                                    <div class="tg-button-wrap">
                                        <a href="contact.jsp" class="btn arrow-btn">Apply Now <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="instructor__item-two tg-svg">
                                ...
                                <div class="instructor__content-two">
                                    <h3 class="title"><a href="contact.jsp">Become a Student</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer__widget">
                            <div class="logo mb-35">
                                <a href="index.jsp"><img src="assets/img/logo/secondary_logo.svg" alt="img"></a>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__link">
                                <ul class="list-wrap">
                                    <li><a href="events-details.jsp">Our values</a></li>
                                    <li><a href="events-details.jsp">Our advisory board</a></li>
                                    <li><a href="events-details.jsp">Our partners</a></li>
                                    <li><a href="events-details.jsp">Become a partner</a></li>
                                    <li><a href="events-details.jsp">Work at Future Learn</a></li>
                                    <li><a href="events-details.jsp">Quizlet Plus</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer__widget">
                            ...
                            <div class="footer__link">
                                <ul class="list-wrap">
                                    ...
                                    <li><a href="instructor-details.jsp">Become Teacher</a></li>
                                    <li><a href="blog.jsp">Blog</a></li>
                                    <li><a href="instructor-details.jsp">Instructor</a></li>
                                    <li><a href="events-details.jsp">Events</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="footer__bottom-menu">
                            <ul class="list-wrap">
                                <li><a href="contact.jsp">Term of Use</a></li>
                                <li><a href="contact.jsp">Privacy Policy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
