                                ...
                                <div class="dashboard__content-title">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <c:if test="${sessionScope.account.role_id==1}">
                                                <a href="AddManager" class="btn btn-two">Add New Manager</a>
                                            </c:if>
                                        </div>  
                                    </div>
                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="dashboard__quiz-info">
                                                                    <h6 name="id" class="title">${l.user_id}</h6>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="dashboard__quiz-info">
                                                                    <h6 class="title">${l.email}</h6>
                                                                </div>
                                                            </td>
                                                            <c:if test="${sessionScope.account.role_id==1}">
                                                                <td>
                                                                    <div class="dashboard__quiz-info">
                                                                        <h6 class="title">${l.appoint_name}</h6>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="dashboard__quiz-info">
                                                                        <h6 class="title">${l.organization_name}</h6>
                                                                    </div>
                                                                </td>
                                                            </c:if>
                                                            <c:if test="${sessionScope.account.role_id==2}">
                                                                <td>
                                                                    <div class="dashboard__quiz-info">
                                                                        <h6 class="title">${l.status}</h6>
                                                                    </div>
                                                                </td>
                                                            </c:if>
                                                            <td style="text-align: center">
                                                                <div class="dashboard__review-action" style="justify-content: center">
                                                                    <c:if test="${sessionScope.account.role_id==1}">
