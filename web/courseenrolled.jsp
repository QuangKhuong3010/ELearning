                                        ...
                                        <ul class="navigation">
                                            ...
                                            <li class="active menu-item-has-children"><a href="#">Dashboard</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="active menu-item-has-children"><a href="student-dashboard.html">Student Dashboard</a>
                                                        <ul class="sub-menu">
                                                            <li><a href="student-dashboard.html">Dashboard</a></li>
                                                            <li><a href="student-profile.html">Profile</a></li>
                                                            <li class="active"><a href="student-enrolled-courses.html">Enrolled Courses</a></li>
